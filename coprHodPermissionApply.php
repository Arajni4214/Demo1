  ...
  ?>
	<form role="form" name="form" id="form" method="post" action="coprHodPermissionSave.php" onsubmit="return validateForm(this.id);">
      <div class="<?php echo $_SESSION['boxStyleClass']; ?>"<?php echo ' '.$_SESSION[countBox(++$countingBox)]; ?>>
		...
		<div><center><h4><p>Indemnification Certificate from Head of Division</p></h4></center></div>
        <div class="box-body border-radius-none">
		<?php include('messageCallOut.php'); ?>
	<div class="row">
		<div class="col-md-12">
			<p>It is being stated that Computer software <b style='border-bottom:dotted'> ______________________________________________________________________________</b>has been developed by <b style='border-bottom:dotted'>_________________________________________________________________________ </b> employee(s) of National Informatics Centre, Ministry of Communication and Information Technology , Govt. of India under project. <b style='border-bottom:dotted'>_________________________________________________________________________ </b></p>
			<p>I certify that there is no Copyright violation in the above stated Computer Program/Software.</p>
		</div>
	</div>
